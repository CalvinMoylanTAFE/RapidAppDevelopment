...
echo "<table style=''>";
echo "<tr><th>Id</th><th>Title</th><th>Studio</th><th>Status</th><th>Sound</th><th>Versions</th><th>RecRetPrice</th><th>Rating</th><th>Year</th><th>Genre</th><th>Aspect</th><th>Searched Count</th><th>Score</th><th>Hits</th></tr>";
...
try
{
    ...
    if ($Graph == "Yes") // if the user has checked the "show most searched" button
    {
        ...
        $height = $max * 50; //set the height (this will scale depending on the results)
        ...
        {
            $x = $i * 50 + 10; //get x pos
            $y = $height - $numbers[$i] * 50; //get y pos
            ...
            {
                imagestring($image, 2, $x + 5, $charY, $char, $white); //draw letter

...
$sql = "SELECT Title, Score FROM movies ORDER BY Score DESC LIMIT 8;"; //SQL to get top 10 searched values
        ...
        $backgroundColor = imagecolorallocate($image, 0, 0, 0); //set bg

        $red = imagecolorallocate($image, 208, 208, 208); //set colour
        ...
        imagepng($image, "outRaitingputimage.png"); //save image
        echo "<br><img src='outRaitingputimage.png'><p></p>"; //echo src for img
